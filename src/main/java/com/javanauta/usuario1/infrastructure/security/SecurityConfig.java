package com.javanauta.usuario1.infrastructure.security;
...
public class SecurityConfig {
    ...
    private final com.javanauta.usuario1.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsService userDetailsService;

    // Construtor para injeção de dependências de JwtUtil e UserDetailsService
    @Autowired
    public SecurityConfig(com.javanauta.usuario1.infrastructure.security.JwtUtil jwtUtil, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        com.javanauta.usuario1.infrastructure.security.JwtRequestFilter jwtRequestFilter = new com.javanauta.usuario1.infrastructure.security.JwtRequestFilter(jwtUtil, userDetailsService);
